...
struct RDKIT_DISTGEOMHELPERS_EXPORT EmbedParameters {
  ...
  EmbedParameters(unsigned int maxIterations, int numThreads, int randomSeed,
                  ...
                  const std::map<std::pair<unsigned int, unsigned int> , double> *TO_BE_NAMED_Ptr = NULL, DistGeom::BoundsMatPtr bmatPtr = NULL,
      ...
      : maxIterations(maxIterations),
        ...
        TO_BE_NAMED_Ptr(TO_BE_NAMED_Ptr),
        bmatPtr(bmatPtr),
        ETversion(ETversion){};
};
...
inline void EmbedMultipleConfs(
  ...
  EmbedParameters params(maxIterations, numThreads, seed, clearConfs,
                         ...
                         pruneRmsThresh, onlyHeavyAtomsForRMS, TO_BE_NAMED_Ptr, bmatPtr);
  EmbedMultipleConfs(mol, res, numConfs, params);
};
//! \overload
inline INT_VECT EmbedMultipleConfs(
    ...
    bool enforceChirality = true, bool useExpTorsionAnglePrefs = false,
    bool useBasicKnowledge = false, bool verbose = false,
    double basinThresh = 5.0, bool onlyHeavyAtomsForRMS = false, const std::map<std::pair<unsigned int, unsigned int>, double> *TO_BE_NAMED_Ptr = NULL, DistGeom::BoundsMatPtr bmatPtr = NULL) {
